...
- [ ] **TASK-048** — Retire the old 4 templates (Stack/Banner/Compact/Framed) and the independent 5-color-style system — each of the 6 new templates carries its own deliberate palette from its `DESIGN.md`, so a separate recolor axis on top no longer makes sense. `DevPreviewSwitcher` updated to cycle the new 6.
