...
- [ ] **TASK-041** — Template: Executive Minimal, matching the `digital_business_card_platform` `DESIGN.md` tokens. Ritesh Dhekane's own card migrated onto it (closest fit to the current content).
