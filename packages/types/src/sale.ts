...
/** STAFF = logged through apps/portal's billing UI (the only path that exists today); ONLINE = a future e-commerce checkout (Milestone 6) — nothing sets this yet. */
...
export interface Sale {
  ...
  paymentMethod: PaymentMethod;
  customerName?: string;
  /** Absent for a future source: 'ONLINE' sale — there's no staff member to attribute it to. */
