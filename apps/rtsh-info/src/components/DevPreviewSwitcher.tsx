 ...
 * CardPage.tsx) — cycles the live preview through every template
 * without editing JSON, so reviewing all of them doesn't mean
 * hand-editing a Card record over and over. Never renders in a
 * production build, so it never reaches a real visitor's scanned card.
 */
